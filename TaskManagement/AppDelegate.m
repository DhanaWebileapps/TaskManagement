...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    TMFolderViewController *folderVC = [[TMFolderViewController alloc] initWithNibName:@"TMFolderView" bundle:nil];
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"TasksDataModel" withExtension:@"momd"];
